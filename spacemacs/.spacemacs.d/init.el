...
you should place your code here."
  ...
  (setq eclimd-autostart t
        eclimd-default-workspace (concat (getenv "HOME") "/.eclipse/workspace"))
  (require 'ensime)
